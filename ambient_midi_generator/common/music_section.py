"""
music_section.py: Class to manage adding chords to a track.
"""

import random
from mido import Message
from ambient_midi_generator.common.music_utilities \
     import note_to_number, MAX_ACCENTS_IN_SECTION, TICKS_PER_BAR
